...
New-AzResourceGroupDeployment -ResourceGroupName $resourceGroupName -TemplateUri "C:\Users\phili\Desktop\lab\storage\templates\storage_arm_criar_file_share.json"